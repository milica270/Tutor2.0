<template>
    ...
    <div class="container">
        ...
        <div class="row my-3">
            ...
            <div class="col-md-10">
                <nav class="navbar nav bg-body-tertiary px-3 mb-3"> 
                    ...
                    <li class="nav-item">
                        <Link class="nav-link fs-6 rounded" style="color: white; background: var(--gradient)" :href="route('tutor.dashboard2')">Raspored <i class="bi bi-table"></i></Link>
                    </li>
                    <li class="nav-item">
        ...
        <div class="row my-3">
            ...
            <div class="col-md-10">
                <h3>Raspored</h3>
                <div class="blur" style="width: 22rem; height: 30rem; right: 5rem;"></div>
